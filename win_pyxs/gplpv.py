...
from .utils import LazyVar

_WIN_DEVICE_PATH = LazyVar(_get_device_path)
...
def _get_device_path():
    # Determine the path to the xenstore device using some magic Windows code
...
class XenBusTransportGPLPV(object):
    ...
    def __init__(self):
        ...
        self._logger.debug('Discovered device path: %s', self.path)
        self._open_device()
